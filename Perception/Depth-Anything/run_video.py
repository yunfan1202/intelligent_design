...
if __name__ == '__main__':
    ...
    args.video_path = "assets/examples_video"
    args.outdir = "assets/examples_video_results"
    args.encoder = "vits"  # vits, vitb, vitl

    margin_width = 50

    DEVICE = 'cuda' if torch.cuda.is_available() else 'cpu'
    
    depth_anything = DepthAnything.from_pretrained('checkpoints/depth_anything_{}14'.format(args.encoder)).to(DEVICE).eval()
